# Generated by Django 3.0.2 on 2020-01-19 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emailAddress', models.CharField(blank=True, max_length=250, verbose_name='Email Address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='street_ryders_store.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='street_ryders_store.Order')),
            ],
            options={
                'db_table': 'OrderItem',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='street_ryders_store.Cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='street_ryders_store.Product')),
            ],
            options={
                'db_table': 'CartItem',
            },
