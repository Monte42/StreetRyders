...
urlpatterns = [
    ...
    path('cart/reomve/<int:product_id>', views.cart_remove, name='cart_remove'),
    path('cart/reomve_product/<int:product_id>', views.cart_remove_product, name='cart_remove_product'),
